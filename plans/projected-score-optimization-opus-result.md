...
Two pre-existing test failures are unrelated to this work: NUTRIMATIC_PROJECTED_BOTTOM_UP=0 in the outer environment conflicts with what test-dfs-search sets and unsets locally at 86b7a9a.
